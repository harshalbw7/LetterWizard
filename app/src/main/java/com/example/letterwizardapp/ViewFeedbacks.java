...
public class ViewFeedbacks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] headers = {" Sr.No. ", "  UserName ", "  Rating ", "  Suggestion ", "  Date & Time "};
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    Feedback letter = dataSnapshot.getValue(Feedback.class);
                    String documentKey = dataSnapshot.getKey();

                    TableRow dummy = new TableRow(ViewFeedbacks.this);
                    dummy.setPadding(0,10,0,20);
                    table.addView(dummy);

                    TableRow row = new TableRow(ViewFeedbacks.this);
                    row.setPadding(20,40,20,40);
                    row.setBackgroundResource(R.drawable.back);
                    row.setElevation(20f);
                    row.setGravity(Gravity.CENTER_VERTICAL);

                    TextView column0 = new TextView(ViewFeedbacks.this);
                    column0.setText("  " + String.valueOf(no) + ". ");
                    column0.setTextColor(getResources().getColor(android.R.color.black));
                    row.addView(column0);

                    TextView column1 = new TextView(ViewFeedbacks.this);
                    column1.setText("" + letter.getUserName() + "  ");
                    column1.setTextColor(getResources().getColor(android.R.color.black));
                    row.addView(column1);

                    TextView column2 = new TextView(ViewFeedbacks.this);
                    column2.setText("" + letter.getRating() + "   ");
                    column2.setTextColor(getResources().getColor(android.R.color.black));
                    row.addView(column2);

                    TextView column3 = new TextView(ViewFeedbacks.this);
                    column3.setText("" + letter.getSuggestion() + "   ");
                    column3.setTextColor(getResources().getColor(android.R.color.black));
                    row.addView(column3);

                    TextView column4 = new TextView(ViewFeedbacks.this);
                    column4.setText("" + letter.getDate() + "   ");
                    column4.setTextColor(getResources().getColor(android.R.color.black));
                    row.addView(column4);

                    ImageView column5 = new ImageView(ViewFeedbacks.this);
                    column5.setImageResource(R.drawable.delete);

                    column5.setOnClickListener(v1 -> {
                        AlertDialog.Builder builder = new AlertDialog.Builder(ViewFeedbacks.this,R.style.CustomAlertDialogStyle);
                        builder.setTitle("Delete Feedback");
                        builder.setMessage("Are you sure to delete ?");

                        builder.setPositiveButton("Yes", (dialog, which) -> {
                            assert documentKey != null;
                            DatabaseReference reference = db.getReference("feedback").child(documentKey);
                            reference.removeValue();
                            table.removeView(row);
                            Toast.makeText(ViewFeedbacks.this, "Subject deleted.", Toast.LENGTH_SHORT).show();
                        });
                        ...
                        if (positiveButton != null && negativeButton != null) {
                            positiveButton.setTextColor(ContextCompat.getColor(ViewFeedbacks.this,R.color.black));
                            negativeButton.setTextColor(ContextCompat.getColor(ViewFeedbacks.this,R.color.black));
                        }
                    });
                    row.addView(column5);
                    table.addView(row);
        ...
        manageContent.setOnClickListener(v -> {
            Intent intent = new Intent(ViewFeedbacks.this,ManageContent.class);
        ...
        viewUser.setOnClickListener(v -> {
            Intent intent = new Intent(ViewFeedbacks.this, ViewUser.class);
            intent.putExtra("USERNAME", userName);
            intent.putExtra("EMAIL", email);
            intent.putExtra("PASSWORD", password);
            startActivity(intent);
        ...
        letterDetails.setOnClickListener(v -> {
            Intent intent = new Intent(ViewFeedbacks.this,letterDetails.class);
            intent.putExtra("USERNAME", userName);
            intent.putExtra("EMAIL", email);
            intent.putExtra("PASSWORD", password);
            startActivity(intent);
        ...
        viewFeedback.setTextColor(Color.parseColor("#D2D2D2"));
        ...
        logout.setOnClickListener(v -> {
            ...
            builder.setPositiveButton("Yes", (dialog, which) -> {
                ...
                Intent intent = new Intent(ViewFeedbacks.this,MainActivity.class);
                startActivity(intent);
            });
            builder.setNegativeButton("Cancel", (dialog, which) -> {
                dialog.dismiss();
